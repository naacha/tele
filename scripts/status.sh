...
echo -e "${CYAN}📊 File Upload STB HG680P Status${NC}"
echo -e "${PURPLE}🖥️ Enhanced with Telegram File Upload${NC}"
echo "================================="
echo ""
...
if [ -f "credentials/credentials.json" ]; then
    ...
    echo -e "${PURPLE}📄 File Upload Status:${NC}"
